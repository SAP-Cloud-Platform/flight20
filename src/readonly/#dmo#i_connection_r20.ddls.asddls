@AbapCatalog.sqlViewName: '/DMO/ICONNE_R20'
...
define view /DMO/I_Connection_R20
  as select from /dmo/connecti_20 as Connection

  association [1..*] to /DMO/I_Flight_R20 as _Flight  on  $projection.AirlineID    = _Flight.AirlineID
                                                    and $projection.ConnectionID = _Flight.ConnectionID
  association [1]    to /DMO/I_Carrier20  as _Airline on  $projection.AirlineID = _Airline.AirlineID

{
  ...
  key   Connection.connection_id    as ConnectionID,
        ...
        @Consumption.valueHelpDefinition: [{  entity: {   name: '/DMO/I_Airport20',
                              element:    'AirportID' } }]
        @Search.defaultSearchElement: true
