CLASS /dmo/cx_flight_legacy20 DEFINITION
  PUBLIC
  ...
  PUBLIC SECTION.
    ...
    CONSTANTS:
      gc_msgid TYPE symsgid VALUE '/DMO/CM_FLIGHT_LE_20',

      BEGIN OF agency_unkown,
        msgid TYPE symsgid VALUE '/DMO/CM_FLIGHT_LE_20',
    ...
    METHODS constructor
      IMPORTING
        ...
        travel_id             TYPE /dmo/travel_id20 OPTIONAL
        booking_id            TYPE /dmo/booking_id20 OPTIONAL
        booking_supplement_id TYPE /dmo/booking_supplement_id20 OPTIONAL
        agency_id             TYPE /dmo/agency_id20 OPTIONAL
        customer_id           TYPE /dmo/customer_id20 OPTIONAL
        carrier_id            TYPE /dmo/carrier20-carrier_id OPTIONAL
        connection_id         TYPE /dmo/connecti_20-connection_id OPTIONAL
        supplement_id         TYPE /dmo/suppleme_20-supplement_id OPTIONAL
        begin_date            TYPE /dmo/begin_date20 OPTIONAL
        end_date              TYPE /dmo/end_date20 OPTIONAL
        booking_date          TYPE /dmo/booking_date20 OPTIONAL
        flight_date           TYPE /dmo/flight_date20 OPTIONAL
        status                TYPE /dmo/travel_status20 OPTIONAL
        currency_code         TYPE /dmo/currency_code20 OPTIONAL
        uname                 TYPE syuname OPTIONAL.

    DATA: mv_travel_id             TYPE /dmo/travel_id20,
          mv_booking_id            TYPE /dmo/booking_id20,
          mv_booking_supplement_id TYPE /dmo/booking_supplement_id20,
          mv_agency_id             TYPE /dmo/agency_id20,
          mv_customer_id           TYPE /dmo/customer_id20,
          mv_carrier_id            TYPE /dmo/carrier20-carrier_id,
          mv_connection_id         TYPE /dmo/connecti_20-connection_id,
          mv_supplement_id         TYPE /dmo/suppleme_20-supplement_id,
          mv_begin_date            TYPE /dmo/begin_date20,
          mv_end_date              TYPE /dmo/end_date20,
          mv_booking_date          TYPE /dmo/booking_date20,
          mv_flight_date           TYPE /dmo/flight_date20,
          mv_status                TYPE /dmo/travel_status20,
          mv_currency_code         TYPE /dmo/currency_code20,
...
CLASS /dmo/cx_flight_legacy20 IMPLEMENTATION.
