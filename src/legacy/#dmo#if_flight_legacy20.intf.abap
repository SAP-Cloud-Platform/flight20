...
INTERFACE /dmo/if_flight_legacy20
  PUBLIC.
...
******************************
  ...
  "! Table type of the table /DMO/TRAVEL20
  TYPES tt_travel             TYPE SORTED TABLE OF /dmo/travel20     WITH UNIQUE KEY travel_id.
  "! Table type of the table /DMO/BOOKING20
  TYPES tt_booking            TYPE SORTED TABLE OF /dmo/booking20    WITH UNIQUE KEY travel_id  booking_id.
  "! Table type of the table /DMO/BOOK_SUP_20
  TYPES tt_booking_supplement TYPE SORTED TABLE OF /dmo/book_sup_20 WITH UNIQUE KEY travel_id  booking_id  booking_supplement_id.
  "! Table type of the table /DMO/FLIGHT20
...
******************
  ...
  TYPES travel_id TYPE /dmo/travel_id20.
  ...
  TYPES booking_id TYPE /dmo/booking_id20.
  ...
  TYPES booking_supplement_id TYPE /dmo/booking_supplement_id20.
...
* IMPORTANT: When you add or remove fields from /DMO/TRAVEL20, /DMO/BOOKING20, /DMO/BOOK_SUP_20 you need to change the following types *
***********************************************************************************************************************************
...
**********************************************************************
  ...
  INCLUDE TYPE ts_travel_key.
  TYPES action_code TYPE /dmo/action_code20.
...
*********
  ...
  TYPES:
    ...
    "! </ul>
    BEGIN OF ENUM action_code_enum STRUCTURE action_code BASE TYPE /dmo/action_code20,
  ...
  TYPES:
    ...
    "! </ul>
    BEGIN OF ENUM travel_status_enum STRUCTURE travel_status BASE TYPE /dmo/travel_status20,
      initial   VALUE IS INITIAL,
      new       VALUE 'N',
      planned   VALUE 'P',
      booked    VALUE 'B',
...
************************
  ...
  INCLUDE TYPE ts_travel_key.
  INCLUDE TYPE /dmo/travel20_data.
  ...
  TYPES booking_id TYPE /dmo/booking_id20.
  INCLUDE TYPE /dmo/booking20_data.
  ...
  TYPES booking_id TYPE /dmo/booking_id20.
  TYPES booking_supplement_id TYPE /dmo/booking_supplement_id20.
  INCLUDE TYPE /dmo/book_sup_20_data.
